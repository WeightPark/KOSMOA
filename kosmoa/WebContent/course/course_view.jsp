...
#ctagdesc { text-align:Center; margin-top:20px; margin-bottom:20px; }

/* 카카오 맵 */
#map { width:1200px; height:500px; }

/* 코스 설명, 간단 설명 */
#imgdesc { width:1180px; height:650px; padding:10px; margin-top:20px; margin-bottom:20px; }
.imgdesc {width:1000px; height:200px; margin:0 auto; padding:5px;  }
.c_img { width:300px; height:200px; display:inline-block; margin:0 10px;}
...
/* 하단 버튼 */
#c_view_btn { width:1200px; height:100px; padding: 10px; }
...
<div id="view">
<div id="title">
<p class="titlebox"><span class="vtop" id="vleft">코스 이름</span> <span class="vtop" id="vright">하트</span></p>
<p class="titlebox"><span class="vtop" id="like">좋아요</span> <span class="vtop" id="like">소요시간</span> <span class="vtop" id="score">3.5</span></p>
</div>
...
<div id="ctagdesc">코스 간단 설명 영역
<p id="ctag">#태그1 #태그2 #태그3 #태그4</p>
<p id="cdesc">코스 간단 설명</p>
</div>
...
<div id="imgdesc">
	<p class="imgdesc">
		<span class="c_img"><a href="#"><img alt="코스 이미지 영역" /></a></span>
		<span class="cp_desc">해당 장소 설명 영역</span>
	</p>
	<p class="imgdesc">
		<span class="c_img"><a href="#"><img alt="코스 이미지 영역" /></a></span>
		<span class="cp_desc">해당 장소 설명 영역</span>
...
<div id="wrap">
	<div id="creview">
		<p id="more">더보기</p>
		<div class="pimg">
			<span class="r_img">코스 이미지 영역</span>
		</div>
		<div class="preview">
			<p>
